...
class BannerController extends Controller
{
    ...
    private function validatePayload(Request $request, ?Banner $banner = null): array
    {
        ...
        return [
            ...
            'starts_at' => ($validated['starts_at'] ?? null) !== null && (string) $validated['starts_at'] !== '' ? (string) $validated['starts_at'] : null,
            'ends_at' => ($validated['ends_at'] ?? null) !== null && (string) $validated['ends_at'] !== '' ? (string) $validated['ends_at'] : null,
