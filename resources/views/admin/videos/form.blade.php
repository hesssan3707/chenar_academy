            ...
            <div class="panel max-w-md">
                <form method="post"
                    ...
                    <label class="field">
                        ...
                        <input name="slug" required value="{{ old('slug', (string) ($videoProduct->slug ?? '')) }}">
                        @error('slug')
                            <div class="field__error">{{ $message }}</div>
                        @enderror
                    </label>
                    ...
                    <div class="grid admin-grid-2 admin-grid-2--flush">
                        <label class="field">
                            ...
                            <input name="currency" required value="{{ old('currency', (string) ($videoProduct->currency ?? 'IRR')) }}">
                            @error('currency')
                                <div class="field__error">{{ $message }}</div>
                            @enderror
                        </label>
                    ...
                    <label class="field">
                        <span class="field__label">مدت زمان (ثانیه)</span>
                        <input type="number" name="duration_seconds" min="0" max="2000000000"
                            value="{{ old('duration_seconds', (string) ($video?->duration_seconds ?? '')) }}">
