...
<body class="spa-body">
    ...
    <div class="spa-layout">
        ...
        <nav class="spa-nav">
            ...
            <a href="{{ route('courses.index') }}" class="spa-nav-item {{ request()->routeIs('courses.*') ? 'active' : '' }}" data-spa-nav="courses">
            ...
            @auth
                <a href="{{ route('panel.dashboard') }}" class="spa-nav-item {{ request()->routeIs('panel.*') ? 'active' : '' }}" data-spa-nav="panel">
