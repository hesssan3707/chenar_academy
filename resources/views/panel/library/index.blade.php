    ...
    <div class="spa-page-shell">
        <div class="user-panel-grid" data-panel-shell>
            ...
            <main class="user-content panel-main panel-library" data-panel-main>
                ...
                @php($selectedProduct = $selectedProduct ?? null)
                @php($userReview = $userReview ?? null)
                ...
                @else
                    @if ($selectedProduct)
                        ...
                        <div class="detail-header">
                            ...
                            <a class="btn btn--ghost" href="{{ route('panel.library.index') }}">بازگشت</a>
                        </div>
                                                                ...
                                                                <div class="stack stack--sm">
                                                                    ...
                                                                    @if ($lesson->lesson_type === 'video' && $lesson->media_id)
                                                                        <video class="product-detail__video" controls preload="metadata">
                                                                            <source
                                                                                src="{{ route('panel.library.lessons.stream', ['product' => $product->slug, 'lesson' => $lesson->id]) }}"
                                                                                type="video/mp4">
                                                                        </video>
                                        ...
                                        <div class="panel">
                                            <div class="stack stack--sm">
                                                ...
                                                @if ($product->type === 'video' && $part->media_id)
                                                    <video class="product-detail__video" controls preload="metadata">
                                                        <source
                                                            src="{{ route('panel.library.parts.stream', ['product' => $product->slug, 'part' => $part->id]) }}"
                                                            type="video/mp4">
                                                    </video>
