...
@section('content')
    <section class="section">
        <div class="container">
            ...
            <p class="page-subtitle">ارسال کد تایید و تنظیم رمز عبور جدید</p>
                ...
                <form method="post" action="{{ route('password.forgot.store') }}" class="stack stack--sm">
                    ...
                    <div class="field">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn--sm" type="button" data-otp-send data-otp-purpose="password_reset">
                                ارسال کد
                            </button>
                        </div>
                        @error('otp_code')
                    ...
                    <div class="form-actions">
                        <button class="btn btn--primary" type="submit">ثبت رمز جدید</button>
                        <a class="btn btn--ghost" href="{{ route('login') }}">بازگشت</a>
                    </div>
                </form>
            </div>
        </div>
